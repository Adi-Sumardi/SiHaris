...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Tambah Jenis Cuti</span>
@endsection

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Tambah Jenis Cuti</h1>
            <p class="text-secondary-500 mt-1">Buat jenis cuti baru untuk perusahaan.</p>
        </div>
...
@section('content')
    <div class="w-full">
        <form action="{{ route('leave-types.store') }}" method="POST" x-data="{ isCarryForward: {{ old('is_carry_forward', false) ? 'true' : 'false' }} }">
            @csrf
                ...
                <div class="card-body space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="2"
                                  ...
                                  placeholder="Deskripsi singkat tentang jenis cuti ini...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="default_days" id="default_days" value="{{ old('default_days', 12) }}"
                        ...
                        <div>
                            ...
                            <select name="color" id="color" class="input w-full @error('color') border-danger-500 @enderror">
                                <option value="primary" {{ old('color', 'primary') === 'primary' ? 'selected' : '' }}>Biru</option>
                ...
                <div class="card-body space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="min_notice_days" id="min_notice_days" value="{{ old('min_notice_days', 3) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="max_consecutive_days" id="max_consecutive_days" value="{{ old('max_consecutive_days') }}"
            ...
            <div class="card mb-6">
                ...
                <div class="card-body space-y-4">
                    ...
                    <div x-show="isCarryForward" x-cloak>
                        ...
                        <input type="number" name="max_carry_forward_days" id="max_carry_forward_days" value="{{ old('max_carry_forward_days', 6) }}"
