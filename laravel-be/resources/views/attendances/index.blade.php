                    ...
                    <td>
                        ...
                        @else
                            <div class="flex items-center justify-end">
                                <a href="{{ route('attendances.create', ['employee_id' => $attendance->employee_id, 'date' => $attendance->date->format('Y-m-d'), 'status' => $attendance->status]) }}" class="text-xs font-medium text-primary-600 hover:text-primary-700 whitespace-nowrap" title="Catat kehadiran untuk karyawan ini">
                                    + Catat
                                </a>
                            </div>
                        @endif
