...
<footer class="bg-secondary-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div class="col-span-2 md:col-span-4 lg:col-span-1">
                <a href="{{ url('/') }}" class="flex items-center gap-3 mb-4">
                    <img src="{{ asset('images/gajipro-logo-new.png') }}" alt="SiHaris" class="w-10 h-10 object-contain rounded-xl">
                    <span class="text-xl font-bold">SiHaris</span>
                </a>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li><a href="{{ route('pricing') }}" class="text-secondary-400 hover:text-white transition-colors text-sm">Harga</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-secondary-400 hover:text-white transition-colors text-sm">Tentang Kami</a></li>
                    ...
                    <li><a href="#" class="text-secondary-400 hover:text-white transition-colors text-sm">Kontak</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{ route('privacy') }}" class="text-secondary-400 hover:text-white transition-colors text-sm">Kebijakan Privasi</a></li>
                    <li><a href="{{ route('terms') }}" class="text-secondary-400 hover:text-white transition-colors text-sm">Syarat & Ketentuan</a></li>
                </ul>
            </div>
        ...
        <div class="border-t border-secondary-800 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p class="text-secondary-500 text-sm">&copy; {{ date('Y') }} SiHaris. All rights reserved.</p>
            <p class="text-secondary-500 text-sm">
                Powered by <a href="https://adilabs.id" target="_blank" rel="noopener noreferrer" class="text-primary-400 hover:text-primary-300 transition-colors font-medium">adilabs.id</a>
            </p>
        </div>
    </div>
</footer>
