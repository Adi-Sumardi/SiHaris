                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="employment_type" id="employment_type" class="input w-full @error('employment_type') border-danger-500 @enderror">
                            ...
                            <option value="YPI Al Azhar" {{ old('employment_type') === 'YPI Al Azhar' || old('employment_type') === 'YPI' ? 'selected' : '' }}>YPI Al Azhar</option>
                            <option value="YAPI" {{ old('employment_type') === 'YAPI' ? 'selected' : '' }}>YAPI</option>
                        </select>
