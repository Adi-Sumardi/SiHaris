                        ...
                        <td>
                            <div class="flex items-center justify-end gap-1">
                                ...
                                @if($leaveReq->isPending())
                                    ...
                                    <a href="{{ route('leave-requests.edit', $leaveReq) }}" class="p-1.5 text-secondary-400 hover:text-primary-600 hover:bg-primary-50 rounded-md transition-colors" title="Edit">
                                ...
                                <button
                                    ...
                                    @click="$dispatch('confirm-dialog', {
                                        ...
                                        message: 'Apakah Anda yakin ingin menghapus pengajuan cuti {{ $leaveReq->request_number }} atas nama {{ $leaveReq->employee?->full_name }}? Tindakan ini tidak dapat dibatalkan.',
                                        confirmText: 'Ya, Hapus',
                                        type: 'danger',
                                        formAction: '{{ route('leave-requests.destroy', $leaveReq) }}'
                                    })"
                                    class="p-1.5 text-secondary-400 hover:text-danger-600 hover:bg-danger-50 rounded-md transition-colors"
                                    title="Hapus"
                                >
