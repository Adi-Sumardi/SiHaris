...
@section('title', 'Import Gaji Karyawan')
...
@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Import Gaji Karyawan</h1>
            <p class="text-secondary-500 mt-1">Upload file Excel untuk mengimpor data gaji karyawan secara massal.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('imports.employee-salaries.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('imports.employee-salaries.template') }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-4 text-sm text-secondary-600">
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><span class="font-medium">ID Karyawan</span> - ID Karyawan, NIK, PIN, atau Nama (wajib)</li>
                            <li><span class="font-medium">Gaji Pokok</span> - Nominal gaji pokok (wajib, contoh: 10000000)</li>
                            <li><span class="font-medium">Tanggal Berlaku</span> - Format YYYY-MM-DD atau DD/MM/YYYY</li>
                            <li><span class="font-medium">Tanggal Berakhir</span> - Opsional (kosongkan jika tanpa batas)</li>
                            <li><span class="font-medium">Metode Pembayaran</span> - Transfer atau Tunai</li>
                            <li><span class="font-medium">Nama Bank</span> - Nama bank (BCA, Mandiri, BRI, dll)</li>
                            <li><span class="font-medium">Nomor Rekening</span> - Nomor rekening bank</li>
                            <li><span class="font-medium">Nama Rekening</span> - Nama pemilik rekening</li>
                            <li><span class="font-medium">Aktif</span> - Ya / Tidak</li>
                            <li><span class="font-medium">Catatan</span> - Keterangan opsional</li>
                        </ul>
                    </div>

                    <div class="bg-primary-50 text-primary-800 p-3 rounded-lg">
                        <p class="font-medium mb-1">Informasi:</p>
                        <p class="text-xs">Pengaturan gaji yang baru diimport dengan status Aktif akan otomatis menonaktifkan pengaturan gaji lama karyawan tersebut.</p>
                    </div>

                    <div class="bg-warning-50 text-warning-700 p-3 rounded-lg">
                        <p class="font-medium mb-1">Penting:</p>
                        <p class="text-xs">Pastikan data karyawan sudah terdaftar sebelum mengimpor data gaji.</p>
                    </div>
                </div>
            </div>
        </div>
