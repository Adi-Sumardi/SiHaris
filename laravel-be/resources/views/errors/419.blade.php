...
<head>
    ...
    <title>419 - Sesi Kedaluwarsa | SiHaris</title>
    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            ...
            <div class="px-8 py-8 text-center">
                <h1 class="text-6xl font-bold bg-gradient-to-r from-violet-500 to-purple-600 bg-clip-text text-transparent mb-2">
                    419
                </h1>
                ...
                <p class="text-slate-500 mb-6 leading-relaxed">
                    ...
                    @else
                        Sesi Anda telah kedaluwarsa karena tidak ada aktivitas. Silakan refresh halaman atau login kembali untuk melanjutkan.
                    @endif
                </p>
                ...
                <div class="bg-violet-50 rounded-xl p-4 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-left">
                            <p class="text-sm font-medium text-violet-700">Kenapa ini terjadi?</p>
                            <p class="text-xs text-violet-600 mt-0.5">Untuk keamanan, sesi akan otomatis berakhir setelah periode tidak aktif.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="px-8 py-4 bg-slate-50 border-t border-slate-100">
                <div class="flex items-center justify-center gap-2">
                    ...
                    <span class="text-sm font-semibold bg-gradient-to-r from-primary-600 to-primary-500 bg-clip-text text-transparent">SiHaris</span>
                </div>
            </div>
        </div>
