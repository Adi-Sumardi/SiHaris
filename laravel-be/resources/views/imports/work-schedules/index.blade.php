...
@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Import Jadwal Kerja</h1>
            <p class="text-secondary-500 mt-1">Upload file Excel untuk mengimpor data jadwal kerja secara massal.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('imports.work-schedules.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('imports.work-schedules.template') }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-4 text-sm text-secondary-600">
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><span class="font-medium">Nama</span> - Nama jadwal (wajib)</li>
                            <li><span class="font-medium">Kode</span> - Kode unik (wajib)</li>
                            <li><span class="font-medium">Jam Masuk</span> - Format HH:MM (wajib)</li>
                            <li><span class="font-medium">Jam Keluar</span> - Format HH:MM (wajib)</li>
                            <li><span class="font-medium">Hari Kerja</span> - Contoh: 1,2,3,4,5 atau Senin-Jumat</li>
                            <li><span class="font-medium">Toleransi Terlambat</span> - Dalam menit</li>
                        </ul>
                    </div>

                    <div class="bg-info-50 text-info-700 p-3 rounded-lg">
                        <p class="font-medium mb-1">Kode Hari:</p>
                        <p class="text-xs">1=Senin, 2=Selasa, 3=Rabu, 4=Kamis, 5=Jumat, 6=Sabtu, 7=Minggu</p>
                    </div>
                </div>
            </div>
        </div>
