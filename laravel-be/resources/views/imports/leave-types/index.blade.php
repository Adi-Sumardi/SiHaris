...
@section('title', 'Import Jenis Cuti')
...
@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Import Jenis Cuti</h1>
            <p class="text-secondary-500 mt-1">Upload file Excel untuk mengimpor data jenis cuti secara massal.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('imports.leave-types.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('imports.leave-types.template') }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-4 text-sm text-secondary-600">
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><span class="font-medium">Nama</span> - Nama jenis cuti (wajib)</li>
                            <li><span class="font-medium">Kode</span> - Kode unik (wajib)</li>
                            <li><span class="font-medium">Jatah Hari</span> - Jumlah hari default</li>
                            <li><span class="font-medium">Berbayar</span> - Ya/Tidak</li>
                            <li><span class="font-medium">Perlu Persetujuan</span> - Ya/Tidak</li>
                            <li><span class="font-medium">Perlu Lampiran</span> - Ya/Tidak</li>
                            <li><span class="font-medium">Tahunan</span> - Ya/Tidak</li>
                        </ul>
                    </div>

                    <div class="bg-info-50 text-info-700 p-3 rounded-lg">
                        <p class="font-medium mb-1">Contoh Jenis Cuti:</p>
                        <ul class="list-disc list-inside text-xs space-y-1">
                            <li>Cuti Tahunan (12 hari)</li>
                            <li>Cuti Sakit (14 hari)</li>
