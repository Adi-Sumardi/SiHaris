...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Buat Pengumuman</span>
@endsection
...
@section('header')
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Buat Pengumuman</h1>
            <p class="text-secondary-500 mt-1">Buat pengumuman baru untuk karyawan.</p>
        </div>
    </div>
@endsection
