...
@section('title', 'Import Data Cuti')
...
@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Import Data Cuti</h1>
            <p class="text-secondary-500 mt-1">Upload file Excel untuk mengimpor data cuti karyawan sebelumnya secara massal.</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('imports.leave-requests.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-3">
                            <a href="{{ route('imports.leave-requests.template') }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body space-y-4 text-sm text-secondary-600">
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li><span class="font-medium">ID Karyawan</span> - ID/PIN/NIK/Email/Nama karyawan (wajib)</li>
                            <li><span class="font-medium">Jenis Cuti</span> - Kode atau nama jenis cuti (wajib)</li>
                            <li><span class="font-medium">Tanggal Mulai</span> - Format YYYY-MM-DD (wajib)</li>
                            <li><span class="font-medium">Tanggal Selesai</span> - Format YYYY-MM-DD (wajib)</li>
                            <li><span class="font-medium">Jumlah Hari</span> - Dihitung otomatis dari tanggal jika kosong</li>
                            <li><span class="font-medium">Setengah Hari</span> - Ya/Tidak</li>
                            <li><span class="font-medium">Sesi Setengah Hari</span> - Pagi/Siang (jika setengah hari)</li>
                            <li><span class="font-medium">Status</span> - Disetujui/Menunggu/Ditolak/Dibatalkan (default Disetujui)</li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-info-50 text-info-700 p-3 rounded-lg">
                        ...
                        <ul class="list-disc list-inside text-xs space-y-1">
                            <li>Gunakan fitur ini untuk mengimpor riwayat cuti karyawan dari sistem lama.</li>
                            <li>Data berstatus "Disetujui" atau "Menunggu" akan otomatis mengurangi/menahan saldo cuti karyawan terkait.</li>
                            <li>Nomor pengajuan cuti dibuat otomatis oleh sistem.</li>
                        </ul>
                    </div>
                </div>
            </div>
