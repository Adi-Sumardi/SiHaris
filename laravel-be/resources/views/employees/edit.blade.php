            ...
            <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nik" id="nik" value="{{ old('nik', $employee->nik ?? $employee->identity_number) }}" class="input w-full @error('nik') border-danger-500 @enderror" placeholder="16 digit nomor induk kependudukan" maxlength="20">
                        @error('nik')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                    </div>
