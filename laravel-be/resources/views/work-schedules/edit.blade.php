...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Edit Jadwal</span>
@endsection

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Edit Jadwal Kerja</h1>
            <p class="text-secondary-500 mt-1">Ubah informasi jadwal kerja.</p>
        </div>
                ...
                <div class="card-body space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $workSchedule->name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="{{ old('code', $workSchedule->code) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="2"
                                  ...
                                  placeholder="Deskripsi singkat tentang jadwal ini...">{{ old('description', $workSchedule->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-danger-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="card-body space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="time" name="start_time" id="start_time" value="{{ old('start_time', $workSchedule->start_time->format('H:i')) }}"
                        ...
                        <div>
                            ...
                            <input type="time" name="end_time" id="end_time" value="{{ old('end_time', $workSchedule->end_time->format('H:i')) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="time" name="break_start" id="break_start" value="{{ old('break_start', $workSchedule->break_start?->format('H:i')) }}"
                        ...
                        <div>
                            ...
                            <input type="time" name="break_end" id="break_end" value="{{ old('break_end', $workSchedule->break_end?->format('H:i')) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="break_duration" id="break_duration" value="{{ old('break_duration', $workSchedule->break_duration) }}"
                    ...
                    <div class="md:w-1/3">
                        ...
                        <input type="number" name="working_hours" id="working_hours" value="{{ old('working_hours', $workSchedule->working_hours) }}"
                ...
                <div class="card-body">
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                        @php
                            ...
                            $selectedDays = old('working_days', $workSchedule->working_days ?? [1, 2, 3, 4, 5]);
                        @endphp
                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="late_tolerance" id="late_tolerance" value="{{ old('late_tolerance', $workSchedule->late_tolerance) }}"
                        ...
                        <div>
                            ...
                            <input type="number" name="early_leave_tolerance" id="early_leave_tolerance" value="{{ old('early_leave_tolerance', $workSchedule->early_leave_tolerance) }}"
                ...
                <div class="card-body space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <input type="checkbox" name="is_flexible" id="is_flexible" value="1"
                               class="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500"
                               {{ old('is_flexible', $workSchedule->is_flexible) ? 'checked' : '' }}>
                        <div>
