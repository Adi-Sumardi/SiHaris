...
@section('breadcrumb')
    ...
    <span class="text-slate-700 font-medium">Tambah Gaji</span>
@endsection

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-secondary-900">Tambah Gaji Karyawan</h1>
            <p class="text-secondary-500 mt-1">Atur gaji pokok dan komponen gaji karyawan.</p>
        </div>
...
@section('content')
    <form action="{{ route('employee-salaries.store') }}" method="POST"
          x-data="{ paymentMethod: '{{ old('payment_method', 'transfer') }}' }">
        @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {{-- Basic Salary --}}
                            <div x-data="currencyInput({{ old('basic_salary', 0) }})">
                            ...
                            <div>
                                ...
                                <input type="date" name="effective_date" id="effective_date" value="{{ old('effective_date', now()->toDateString()) }}"
