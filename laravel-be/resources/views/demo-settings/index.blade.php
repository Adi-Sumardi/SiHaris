    ...
    <div class="card mb-6">
        <div class="card-body">
            ...
            <p class="text-secondary-600 mb-4">
                Anda sedang menggunakan data sampel untuk eksplorasi fitur SiHaris.
        ...
        <div class="card border-2 border-primary-200 bg-primary-50/30">
            ...
            <div class="card-body pt-0">
                <p class="text-secondary-600 text-sm mb-4">
                    Siap menggunakan SiHaris untuk perusahaan Anda? Hapus semua data demo dan mulai memasukkan data karyawan yang sebenarnya.
                </p>
            ...
            <div class="space-y-4" x-data="{ active: null }">
                <div class="border border-secondary-200 rounded-lg">
                    ...
                    <div x-show="active === 1" x-collapse class="px-4 pb-3">
                        <p class="text-secondary-600 text-sm">Mode Demo memungkinkan Anda mencoba semua fitur SiHaris menggunakan data sampel. Anda bisa mengeksplorasi tanpa risiko mengacaukan data perusahaan yang sebenarnya.</p>
                    </div>
                </div>
                ...
                <div class="border border-secondary-200 rounded-lg">
                    ...
                    <div x-show="active === 3" x-collapse class="px-4 pb-3">
                        <p class="text-secondary-600 text-sm">Mode demo tersedia selama masa trial 14 hari. Setelah itu, Anda perlu beralih ke mode produksi atau berlangganan untuk melanjutkan menggunakan SiHaris.</p>
                    </div>
                </div>
            </div>
        </div>
